...
export default function ShoppingFollowUps() {
  ...
  // Modal # Orden de Compra (INTERNACIONAL, antes de avanzar de "Comprado")
  ...
  const productosAgrupados = productosFiltrados.reduce((acc, p) => {
    ...
    return acc;
  }, {} as Record<string, { groupKey: string; cotizacionId: string; ordenCompraId: string | null; nombre: string; tipoCompra: string; chatId: string | null; monedaId: string | null; solicitante: { id: string; nombre: string } | null; tipo: { nombre: string; area: { nombreArea: string } } | null; productos: EstadoProducto[] }>);
