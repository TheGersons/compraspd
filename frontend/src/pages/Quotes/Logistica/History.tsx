...
async function obtenerHistorialGeneral(): Promise<CotizacionHistorial[]> {
  try {
    const response = await fetch(`${API_BASE_URL}/api/v1/historial-general?tipoNombre=logistica`, {
      credentials: "include",
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border-2 border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Seguimiento de cotizaciones logística y sus etapas de proceso
          </p>
        </div>
