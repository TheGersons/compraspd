...
// Mock de un usuario autenticado (¡NECESITAS ESTO!)
const MOCK_USER = {
    id: "user_cln2y12ab0000j2a6652s5l7k", // Usa un CUID válido para el backend
    // Puedes añadir más campos si los necesitas, como name, role, etc.
};
