...
export type QuoteStatus = "open" | "in_review" | "approved" | "rejected" | "expired";
...
export default function StatusBadge({ status }: { status: QuoteStatus }) {
  const label = { open:"Abierta", in_review:"En revisión", approved:"Aprobada", rejected:"Rechazada", expired:"Vencida" }[status];
